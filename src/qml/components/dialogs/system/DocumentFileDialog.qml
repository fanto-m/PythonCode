// DocumentFileDialog.qml - Диалог выбора документа
...
// Файл в qml/components/dialogs/system/
import "../../../styles"
import "../../common"
        ...
        Rectangle {
            ...
            Text {
                ...
                MouseArea {
                    ...
                    onClicked: documentDialog.reject()
                }
            }
            ...
            MouseArea {
                ...
                onMouseXChanged: {
                    if (pressed) {
                        documentDialog.x += mouseX - lastMousePos.x
                    }
                }

                onMouseYChanged: {
                    if (pressed) {
                        documentDialog.y += mouseY - lastMousePos.y
                    }
                }
            }
        }
